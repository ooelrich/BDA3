...
$$\begin{equation}
p(y) = \sum_{i=1}^2 p(y|\theta_i) p(\theta_i) = \frac{1}{2}p_1(y)+\frac{1}{2}p_1(y)
\end{equation}$$

where $p_1(y)$ is normal with mean $1$ and standard deviation $\sigma$ and $p_2(y)$ is normal with mean $2$ and standard deviation $\sigma$. Using $\sigma=2$ the density will be given by
